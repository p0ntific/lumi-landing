...
export function Landing() {
    ...
    return (
        ...
        >
            {/* Container wrapper для десктопа */}
            <div className="w-full max-w-[1000px] mx-auto px-4 sm:px-6 lg:px-8">
                {/* Block 1: Hero */}
                <section className="flex flex-col lg:flex-row lg:items-center lg:justify-between pt-12 lg:pt-20 gap-8 lg:gap-12">
                    <motion.div
                        className="flex flex-col items-center lg:items-start text-center lg:text-left lg:flex-1"
                        style={{ y: heroTextY }}
                    >
                        <motion.h1
                            className="text-[28px] sm:text-[36px] lg:text-[44px] font-medium leading-tight"
                        ...
                        <motion.p
                            className="mt-4 lg:mt-6 text-[14px] sm:text-lg lg:text-xl leading-snug"
                        ...
                        <motion.div
                            className="mt-6 lg:mt-8 w-full max-w-[320px]"
                            initial={{ opacity: 0, y: 20 }}
                            animate={{ opacity: 1, y: 0 }}
                            transition={{
                                duration: 0.8,
                        ...
                        >
                            <MagneticButton
                                className="w-full font-medium text-base rounded-2xl min-h-14"
                                style={{
                    ...
                    <motion.div
                        className="lg:flex-1 lg:max-w-[500px]"
                        style={{ y: heroImageY }}
                ...
                <RevealSection className="mt-[80px] lg:mt-[140px]">
                    <section className="w-full flex flex-col lg:flex-row lg:items-center lg:gap-16 items-center gap-4 mx-auto text-center lg:text-left">
                        <div className="flex flex-col items-center lg:items-start max-w-[320px] lg:max-w-[450px] lg:flex-1">
                            <h2
                                className="text-[28px] sm:text-[32px] lg:text-[40px] font-medium leading-tight"
                                style={{ color: LUMI_BLACK }}
                            >
                            ...
                            <p
                                className="mt-4 text-[14px] sm:text-base lg:text-lg leading-snug font-normal"
                                style={{ color: LUMI_SUBTEXT }}
                            >
                            ...
                            <div className="mt-6 w-full max-w-[320px] hidden lg:block">
                                <MagneticButton
                        ...
                        <motion.div
                            className="relative w-full max-w-[305px] lg:max-w-[400px] mx-auto lg:mx-0 rounded-b-3xl mt-4 lg:mt-0 overflow-hidden lg:flex-1"
                            whileHover={{ scale: 1.02 }}
                ...
                <RevealSection className="mt-[80px] lg:mt-[140px]">
                    <section className="flex flex-col items-center max-w-[320px] lg:max-w-full mx-auto">
                        <h2
                            className="text-[26px] sm:text-[28px] lg:text-[36px] font-medium text-center"
                            style={{ color: LUMI_BLACK }}
                        >
                            Это для тебя, если:
                        </h2>
                        <p
                            className="mt-2 text-[14px] lg:text-base text-center"
                            style={{ color: LUMI_SUBTEXT, opacity: 0.5 }}
                        >
                            Если узнала тут себя — попробуй Lumi
                        </p>

                        <StaggerContainer className="mt-8 lg:mt-12 w-full flex flex-col lg:flex-row lg:justify-center lg:gap-8 gap-[16px]">
                            {[
                                {
                                    img: forYou1,
                                ...
                                <div key={index} className="contents lg:block">
                                    <AnimatedCard className="flex lg:flex-col items-center lg:text-center lg:max-w-[280px] lg:p-6 lg:rounded-3xl lg:bg-[rgba(247,246,249,0.5)]">
                                        <Image
                                            src={item.img}
                                            alt=""
                                            className="flex-shrink-0 w-[80px] h-[80px] lg:w-[100px] lg:h-[100px] object-contain"
                                            width={100}
                                            height={100}
                                        />
                                        <p
                                            className="text-[15px] lg:text-base leading-snug pt-0.5 lg:pt-0 lg:mt-4 font-normal"
                                            style={{ color: LUMI_BLACK }}
                                        >
                                            {item.text}
                                        </p>
                ...
                <RevealSection className="mt-[80px] lg:mt-[140px]">
                    <section className="relative flex flex-col lg:flex-row items-center text-center lg:text-left lg:gap-12">
                        <motion.div
                            className="lg:flex-1 lg:order-2 w-full lg:max-w-[500px]"
                        ...
                        <div className="lg:flex-1 lg:order-1">
                            ...
                            <div className="absolute lg:relative top-[40px] lg:top-0 left-0 right-0 pt-10 lg:pt-0 pb-4 px-6 lg:px-0 text-center lg:text-left flex-shrink-0">
                                <h2
                                    className="text-[26px] sm:text-[30px] lg:text-[36px] font-medium"
                                ...
                                <p
                                    className="mt-3 lg:mt-4 text-[14px] lg:text-base leading-snug max-w-[320px] lg:max-w-none mx-auto lg:mx-0 font-normal"
                            ...
                            <div className="mt-4 lg:mt-8 w-full max-w-[320px] mx-auto lg:mx-0">
                                <MagneticButton
                                    className="w-full font-medium text-base rounded-2xl min-h-14"
                                    style={{
                                        backgroundColor: LUMI_BLACK,
                    ...
                    <section className="flex flex-col items-center mx-auto max-w-[320px] lg:max-w-full">
                        ...
                        >
                            <Image
                                src={girlsImg}
                                alt=""
                                className="w-[190px] lg:w-[240px] h-auto object-contain"
                                width={240}
                            />
                        </motion.div>
                        <h2
                            className="mt-5 text-[26px] sm:text-[28px] lg:text-[36px] font-medium text-center"
                            style={{ color: LUMI_BLACK }}
                        >
                            Те, кто уже попробовал
                        </h2>
                        <p
                            className="mt-1.5 text-[15px] lg:text-base text-center font-normal"
                            style={{ color: LUMI_SUBTEXT }}
                        >
                            Отзывы наших подруг
                        </p>

                        <StaggerContainer className="mt-6 lg:mt-10 w-full lg:grid lg:grid-cols-2 lg:gap-6">
                            {[1, 2].map((_, index) => (
                                <AnimatedCard
                                    key={index}
                                    className={`w-full rounded-[28px] bg-[rgba(247,246,249,0.5)] p-[24px] sm:p-7 ${
                                        index === 1 ? "hidden lg:block" : ""
                                    }`}
                                >
                                    <p
                                        className="text-[15px] lg:text-base leading-snug font-normal"
                                        style={{ color: LUMI_BLACK }}
                                    >
                                    ...
                                    <div className="flex items-center gap-3 mt-6 lg:mt-8">
                                        <Image
                                            src={arinaImg}
                                            alt="Арина"
                                            className="rounded-full w-10 h-10 lg:w-12 lg:h-12 object-cover flex-shrink-0"
                                            width={48}
                                            height={48}
                                        />
                                        <span
                                            className="text-[15px] lg:text-base font-normal"
                                            style={{ color: LUMI_BLACK }}
                                        >
                                            {index === 0 ? "Арина" : "Мария"}
                                        </span>
                        ...
                        <div className="mt-6 lg:mt-10 w-full max-w-[320px]">
                            <MagneticButton
                                className="w-full font-normal text-base rounded-2xl min-h-14"
                                style={{
                                    backgroundColor: LUMI_BLACK,
                                    color: LUMI_WHITE,
                                }}
                ...
                {/* Block 7: Footer */}
                <RevealSection className="mt-[80px] lg:mt-[100px] mb-8">
                    <section className="flex flex-col lg:flex-row lg:items-center lg:justify-between items-center gap-8">
                        <motion.div
                            style={{
                                background: `linear-gradient(180deg, ${LUMI_GRADIENT_START} 0%, ${LUMI_GRADIENT_END} 100%)`,
                            }}
                            className="w-full lg:max-w-[400px] p-[40px] rounded-3xl flex flex-col gap-3"
                            whileHover={{
                                boxShadow:
                        ...
                        >
                            ...
                            <img
                                ...
                                alt="LUMI"
                                className="p-[40px] lg:p-0 w-full max-w-[300px] lg:max-w-[400px] h-auto object-contain"
                            />
                        </motion.div>
                    </section>
                </RevealSection>
